...
/******************************/
.tyg-div{float:left;position:absolute;left:5%;top:20%;}
.tyg-div>ul>li{font-size: 30px;color:#2ec0f6;}
...
#page1 .imgGroug,	#page1 .img0,#page1 .img1,#page1 .img2,
.title0,.title1{position:absolute;top:50%;left:50%}
	...
	.title1{color:#fff;font-size:20px;height:30px;line-height:30px;margin:-230px 0 0 0} 
	#page1 .img0,#page1 .img1,#page1 .img2,#page1 .imgGroug{z-index:1}
	#page1 .imgGroug{width:170px;height:170px;margin:-126px 0 0 -85px}
	#page1 .imgGroug ul{width:170px;height:170px}
