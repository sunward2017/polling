...
export const CMDTYPES = [{value:"1",label:"拍照"},{value:"2",label:"红外"},{value:"3",label:"温湿度"},{value:'4',label:'录制视频'},{value:"7",label:'停留'},{value:'8',label:'语音讲解'},{value:'5',label:'语音播放'}];

export const TASKEXECTYPES = {"0":"未执行","1":"执行中","2":"执行完毕","3":"超时","4":"中断"};

export const CMDSTATUS={'1':'gray','2':'primary','3':'success','9':'warning','5':'danger','6':'info','7':'init'}; 
